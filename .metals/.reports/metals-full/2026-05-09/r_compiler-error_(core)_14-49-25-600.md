...
### java.lang.StringIndexOutOfBoundsException: Range [1587, 1587 + -5) out of bounds for length 25319
...
class Cache(
  ...
  // RNG
  private val rngState = Reg(@@BigInt(config.xlen * 2, scala.util.Random)
