...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree
       tree position: line 82 of file://<WORKSPACE>/core/src/main/scala/riscv/plugins/Cache.scala
            tree tpe: <error>
              symbol: <none>
...
== Source file context for tree position ==
    ...
    79       var R = address(byteIndexBits + wordIndexBits + half, half bits)
    80 
    81       for (i <- 0 until feistelStages) {
    82         var temp = R ^ _CURSOR_key(i)
    83         R = L
    84         L = temp
    85       }
...
class Cache(
  ...
  private def getSetIndex(address: UInt, key: Vec[UI]): UInt = {
