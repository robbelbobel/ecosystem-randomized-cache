error id: file://<WORKSPACE>/core/src/main/scala/riscv/plugins/Cache.scala:
file://<WORKSPACE>/core/src/main/scala/riscv/plugins/Cache.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -riscv/evictWayGlobal.
	 -riscv/evictWayGlobal#
	 -riscv/evictWayGlobal().
	 -spinal/core/evictWayGlobal.
	 -spinal/core/evictWayGlobal#
	 -spinal/core/evictWayGlobal().
	 -spinal/lib/evictWayGlobal.
	 -spinal/lib/evictWayGlobal#
	 -spinal/lib/evictWayGlobal().
	 -evictWayGlobal.
	 -evictWayGlobal#
	 -evictWayGlobal().
	 -scala/Predef.evictWayGlobal.
	 -scala/Predef.evictWayGlobal#
	 -scala/Predef.evictWayGlobal().
offset: 6247
