error id: file://<WORKSPACE>/core/src/main/scala/riscv/Core.scala:
file://<WORKSPACE>/core/src/main/scala/riscv/Core.scala
...
offset: 2589
uri: file://<WORKSPACE>/core/src/main/scala/riscv/Core.scala
text:
```scala
package riscv
  ...
  def apply(
    ...
    pipeline.addPlugins(
      Seq(
        ...
        new Fen@@ce(Set(pipeline.execute)),
        new Marker,
        new RNG()
      ) ++ extraPlugins
    )
