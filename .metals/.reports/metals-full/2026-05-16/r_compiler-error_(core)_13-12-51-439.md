...
### scala.reflect.internal.Types$TypeError: illegal cyclic inheritance involving <$anon: spinal.core.Area>
      ...
      private def insertRspInCache(address: UInt): Unit = {
        ...
        when(
          ...
          if (invalidTags != 0) {
            ...
            when(v@@ + invalidTags + inserted.asUInt.resized > totalWays) {
