error id: file://<WORKSPACE>/core/src/main/scala/riscv/plugins/RNG.scala:RngBuffer#
file://<WORKSPACE>/core/src/main/scala/riscv/plugins/RNG.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -riscv/RngBuffer#
	 -spinal/core/RngBuffer#
	 -spinal/lib/RngBuffer#
	 -RngBuffer#
	 -scala/Predef.RngBuffer#
offset: 5857
uri: file://<WORKSPACE>/core/src/main/scala/riscv/plugins/RNG.scala
text:
```scala
...
class Rng(allowUninitializedRng: Boolean = false) extends Plugin[Pipeline] with RngService {
  ...
  private val rngbuffers = mutable.ArrayBuffer[Rn@@gBuffer]()
