error id: 74F9E9F2281CAD078E9ED1A50EC7004D
...
class Cache(
  ...
  private val needsAge = 
    insertionPolicy == InsertionPolicy.LRU ||   // Insertion Policy
      (invalidTags > 0 && (                     // Eviction Policy
  ...
  private case class CacheEntry() extends Bundle {
    ...
    val age: UInt =  if (needsAge) UInt(log2Up(skews * sets * ways) bits) else null
    val valid: Bool = Bool()
  }
...
scala.None$.get(Option.scala:529)
	...
	scala.reflect.macros.runtime.MacroRuntimes$MacroRuntimeResolver.<init>(MacroRuntimes.scala:63)
	scala.reflect.macros.runtime.MacroRuntimes.$anonfun$standardMacroRuntime$3(MacroRuntimes.scala:48)
	...
	scala.collection.mutable.AbstractMap.getOrElseUpdate(Map.scala:85)
	scala.reflect.macros.runtime.MacroRuntimes.standardMacroRuntime(MacroRuntimes.scala:48)
	scala.reflect.macros.runtime.MacroRuntimes.standardMacroRuntime$(MacroRuntimes.scala:41)
	scala.meta.internal.pc.MetalsGlobal$MetalsInteractiveAnalyzer.standardMacroRuntime(MetalsGlobal.scala:85)
	scala.tools.nsc.typechecker.AnalyzerPlugins$$anon$12.default(AnalyzerPlugins.scala:473)
	scala.tools.nsc.typechecker.AnalyzerPlugins$$anon$12.default(AnalyzerPlugins.scala:470)
	scala.tools.nsc.typechecker.AnalyzerPlugins.invoke(AnalyzerPlugins.scala:411)
	scala.tools.nsc.typechecker.AnalyzerPlugins.pluginsMacroRuntime(AnalyzerPlugins.scala:470)
	scala.tools.nsc.typechecker.AnalyzerPlugins.pluginsMacroRuntime$(AnalyzerPlugins.scala:470)
	scala.meta.internal.pc.MetalsGlobal$MetalsInteractiveAnalyzer.pluginsMacroRuntime(MetalsGlobal.scala:85)
	scala.reflect.macros.runtime.MacroRuntimes.macroRuntime(MacroRuntimes.scala:35)
	scala.reflect.macros.runtime.MacroRuntimes.macroRuntime$(MacroRuntimes.scala:35)
	scala.meta.internal.pc.MetalsGlobal$MetalsInteractiveAnalyzer.macroRuntime(MetalsGlobal.scala:85)
	scala.tools.nsc.typechecker.Macros$MacroExpander.$anonfun$expand$2(Macros.scala:653)
	scala.tools.nsc.Global.withInfoLevel(Global.scala:227)
	scala.tools.nsc.typechecker.Macros$MacroExpander.expand(Macros.scala:647)
	scala.tools.nsc.typechecker.Macros$MacroExpander.apply(Macros.scala:609)
	scala.tools.nsc.typechecker.Macros.standardMacroExpand(Macros.scala:810)
	scala.tools.nsc.typechecker.Macros.standardMacroExpand$(Macros.scala:808)
	scala.meta.internal.pc.MetalsGlobal$MetalsInteractiveAnalyzer.standardMacroExpand(MetalsGlobal.scala:85)
	scala.tools.nsc.typechecker.AnalyzerPlugins$$anon$10.default(AnalyzerPlugins.scala:457)
	scala.tools.nsc.typechecker.AnalyzerPlugins$$anon$10.default(AnalyzerPlugins.scala:454)
	scala.tools.nsc.typechecker.AnalyzerPlugins.invoke(AnalyzerPlugins.scala:411)
	scala.tools.nsc.typechecker.AnalyzerPlugins.pluginsMacroExpand(AnalyzerPlugins.scala:454)
	scala.tools.nsc.typechecker.AnalyzerPlugins.pluginsMacroExpand$(AnalyzerPlugins.scala:454)
	scala.meta.internal.pc.MetalsGlobal$MetalsInteractiveAnalyzer.pluginsMacroExpand(MetalsGlobal.scala:116)
	scala.tools.nsc.typechecker.Macros.macroExpand(Macros.scala:799)
	scala.tools.nsc.typechecker.Macros.macroExpand$(Macros.scala:792)
	scala.meta.internal.pc.MetalsGlobal$MetalsInteractiveAnalyzer.macroExpand(MetalsGlobal.scala:85)
	...
	scala.tools.nsc.typechecker.Typers$Typer.adapt(Typers.scala:1219)
	scala.tools.nsc.typechecker.Implicits$ImplicitSearch.typedImplicit1(Implicits.scala:779)
	...
	scala.tools.nsc.typechecker.Implicits.inferImplicitFor(Implicits.scala:48)
	...
	scala.tools.nsc.typechecker.Typers$Typer.$anonfun$adapt$1(Typers.scala:900)
	scala.tools.nsc.typechecker.Typers$Typer.adaptToImplicitMethod$1(Typers.scala:491)
	scala.tools.nsc.typechecker.Typers$Typer.adapt(Typers.scala:1242)
	...
	scala.meta.internal.pc.ScalaPresentationCompiler.$anonfun$signatureHelp$1(ScalaPresentationCompiler.scala:433)
